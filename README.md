Proyek Sistem Rumah Sakit atau disebut Soal TUBES No. 20 Data Pasien ini merupakan implementasi struktur data Multi Linked List dengan jenis relasi Many-to-Many. Sistem ini digunakan untuk mencatat berbagai jenis penyakit serta pasien yang memiliki keterkaitan dengan satu atau lebih penyakit tersebut. (Kami mengerjakan dengan 1 laptop dan komunikasi kami lewat discord jadi di github konstribusi yang terlihat hanya 1 pihak tapi sebenarnya 2 pihak).
